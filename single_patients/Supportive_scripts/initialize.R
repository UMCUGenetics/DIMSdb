initialize <- function(inputfolder, outputfolder, HMDB_info_folder, project){
  ...
  # load(paste("./results/adductSums_negative.RData"))
  load(paste(inputfolder,"adductSums_negative.RData", sep = "/"))
  outlist.neg.adducts.HMDB=outlist.tot
  # load(paste("./results/adductSums_positive.RData"))
  load(paste(inputfolder,"adductSums_positive.RData", sep = "/"))
  ...
  # NEW MAC_MARTEN PIECE
  
  outlist.adducts.stats = statistics_z(peaklist = as.data.frame(outlist.adducts.HMDB), #as.data.frame(adducts.neg.pos),
  ...
  #                                      "./results/plots/adducts",
  #                                      "./results/allpgrps_stats.txt",
  ...
  # load("/Users/mkerkho7/testmap-master/HMDB_with_info_relevance_IS_C5OH.RData")
  load(HMDB_info_folder)
  ...
  load(paste(inputfolder,"outlist_identified_negative.RData", sep = "/"))
  # load("./results/outlist_identified_negative.RData")
  ...
  load(paste(inputfolder,"outlist_identified_positive.RData", sep = "/"))
  # load("./results/outlist_identified_positive.RData")
  ...
  save(outlist.adducts, outlist.neg.ident, outlist.pos.ident, file=paste0(outputfolder, "/ViewInShiny_", project, ".RData"))
  # save(outlist.adducts, outlist.neg.ident, outlist.pos.ident, file="./results/ViewInShiny.RData")
