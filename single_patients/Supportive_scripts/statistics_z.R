...
statistics_z <- function(peaklist, outputfolder, control_label, case_label, sortCol, patients, plot=TRUE, adducts=FALSE){
  ...
  #MAKE IT MAC PROOF FOR MARTENS MAC
  # dir.create(paste0("/Users/mkerkho7/DIMS2_repo/Results_DIMS2/",project), showWarnings = FALSE)
  # dir.create(paste0("/Users/mkerkho7/DIMS2_repo/Results_DIMS2/",project,"/plots"), showWarnings = FALSE)
  # dir.create("/Users/mkerkho7/DIMS2_repo/Results_DIMS2/plots/positive", showWarnings = F)
  # dir.create("/Users/mkerkho7/DIMS2_repo/Results_DIMS2/plots/negative", showWarnings = F)
  # dir.create(paste0("/Users/mkerkho7/DIMS2_repo/Results_DIMS2/",project,"/plots/adducts/"), showWarnings = FALSE)
  dir.create(paste0(outputfolder, project, "/plots/adducts/"), recursive = TRUE, showWarnings = FALSE)
  # OLD WAY
  # dir.create("./results/plots", showWarnings = F)
  # dir.create("./results/plots/positive", showWarnings = F)
  # dir.create("./results/plots/negative", showWarnings = F)
  # dir.create("./results/plots/adducts", showWarnings = F)
  ...
  write.table(peaklist, file=paste0(outputfolder, project, "/allpgrps_stats.txt"), sep="\t")
